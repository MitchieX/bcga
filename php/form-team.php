...
if(isset($_POST['email'])) {
    ...
    $email_to = "contato@bcga.tech";
    $email_subject = "Entre pro Time";
    ...
    if(isset($_POST['taskOption'])){
      ...
      case 'Business Partner':
          echo 'value2<br/>';
          break;
        case 'Sales Partnership':
            echo 'value2<br/>';
            break;
            case 'Digital influencer partner':
              echo 'value2<br/>';
              break;
          default:
              # code...
  ...
  if(strlen($error_message) > 0) {
    ...
    $email_message .= "Quero fazer parte: ".clean_string($team)."\n";
    ...
    $email_message .= "Cargo: ".clean_string($position)."\n";
...
echo "<script>alert("Obrigado! Em breve entraremos em contato");window.location.assign('http://www.bcga.tech/');</script>";
